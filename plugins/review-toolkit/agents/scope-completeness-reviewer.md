...
**AC-ID positional fallback rule (normative home: this file — your independence contract precludes reading pipeline docs at review time, so the rule lives here):** <!-- LOCKSTEP-BEGIN ac-id-rule -->
