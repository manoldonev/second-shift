...
# this copy is inline and pinned byte-identical by the `checked-call` LOCKSTEP markers, which
# scripts/check-lockstep-pairs.sh discovers and compares. Edit one, edit both.
