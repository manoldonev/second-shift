...
remain the approval gate's job — and on the lane, the REVIEW session, which renders every
screen at the head and compares it with its frame. No pixel-diff or screenshot-diff gate exists in
