...
| **set-status** — advance the tracker’s own status | label swaps via `bash "${CLAUDE_PLUGIN_ROOT}/tools/gh-bot.sh"` | *no-op* — operator moves the ticket manually after promoting the PR |
