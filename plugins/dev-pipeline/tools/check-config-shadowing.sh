...
CHECKS=(
  ...
  "skills/build/milestone-gate.sh|paths.plansDir|plans dir"
  "skills/build/milestone-gate.sh|baseBranch|lean base branch"
  "skills/build/milestone-gate.sh|extraLanes|commands.<host>.extraLanes (#379)"
  "skills/build/milestone-gate.sh|design.liveRender|design live-render verification"
  "skills/build/branch-prefix.sh|tracker.branchPrefix|work-branch namespace"
  "skills/run/SKILL.md|ticketTag|topology.repos.<id>.ticketTag pair routing (#4)"
