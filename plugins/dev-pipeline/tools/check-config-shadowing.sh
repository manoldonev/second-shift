...
CHECKS=(
  ...
  "skills/build/lean-gate.sh|paths.plansDir|plans dir"
  "skills/build/lean-gate.sh|baseBranch|lean base branch"
  "skills/build/lean-gate.sh|extraLanes|commands.<host>.extraLanes (#379)"
  "skills/build/lean-gate.sh|design.liveRender|design live-render verification"
